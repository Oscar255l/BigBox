<?php include 'backend/verificar_sesion.php'; 
  ...
  $consejosEmprendedores = [
    ...
    "Utiliza imágenes de alta calidad: Publica fotos atractivas que resalten tus productos; asegúrate de que sean claras y profesionalmente editadas.",
                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="fire-bubble-art d-flex justify-content-between  align-items-center">
                            ...
                            <h3 class="mb-0" style="margin-top: -50px; margin-left: 30px; font-size: 36px; font-weight: bold; text-align: center;">
...
<script>
  ...
  setInterval(mostrarConsejoUsuarioAleatorio, 45000);
</script>
...
<script>
  ...
  // Cambiar el consejo cada 45 segundos
  setInterval(mostrarConsejoEmprendedorAleatorio, 45000);
</script>
    ...
    <div class="video-container">
        ...
        <video class="reproductor-video" width="640" height="360" controls>
            <source src="videos/emprendimientos_locales.mp4" type="video/mp4">
            Tu navegador no soporta el elemento de video.
        </video>
        <video class="reproductor-video" width="640" height="360" controls>
            <source src="videos/principos_negocios.mp4" type="video/mp4">
            Tu navegador no soporta el elemento de video.
        </video>
    </div>
