...
// Consulta para obtener las historias
$query = "SELECT s.id_historia, s.nom_historia, s.desc_historia, s.imagen_his, s.id_usuario, u.nom_usuario 
          FROM historias s
            ...
            <tbody>
                <?php while ($row = pg_fetch_assoc($result)) { ?>
                    <tr>
                        ...
                        <td>
                            <form action="../eliminar/eliminar_historias.php" method="POST" style="display:inline;">
